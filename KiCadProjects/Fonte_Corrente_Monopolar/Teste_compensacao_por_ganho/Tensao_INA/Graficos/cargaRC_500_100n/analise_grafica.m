...
p = polyfit(frequencias, I_ajustada,5); #devolve os coeficientes do polinomio, ultimo argumento eh o grau
p_1 = polyfit(frequencias, I_N_ajustada,5); #devolve os coeficientes do polinomio, ultimo argumento eh o grau
...
title('Carga RC paralelo de 504 Ω e 100nF');
ylabel('Corrente fornecida [mA]');
xlabel('Frequência [Hz]');
h = legend ("Com ajuste de ganho","pontos experimentais com ajuste de ganho",
"Sem ajuste de ganho","pontos experimentais sem ajuste de ganho","Ideal");
...
saveas(1,'correnteXFreq_Carga_RC_500_100n.jpg')

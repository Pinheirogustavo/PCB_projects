...
figure(1); hold on
semilogx(xx,yy_R,'k', 'linewidth', 2, frequencias, I_ajustada_R, 'ks', 'linewidth', 1);
semilogx(xx,yy_1_R,'--k', 'linewidth', 2, frequencias, I_N_ajustada_R, 'ko');
...
semilogx(xx,yy_RC1,'k', 'linewidth', 2, frequencias, I_ajustada_RC1, 'ks', 'linewidth', 1);
...
xlabel('Frequência [Hz]');
h = legend (
"Com ajuste de ganho - 504 Ω // 1,8pF","pontos experimentais com ajuste de ganho -504 Ω // 1,8pF",
"Sem ajuste de ganho - 504 Ω // 1,8pF","pontos experimentais sem ajuste de ganho - 504 Ω // 1,8pF",
"Com ajuste de ganho - 504 Ω // 100nF","pontos experimentais com ajuste de ganho - 504 Ω // 100nF",
"Sem ajuste de ganho - 504 Ω // 100nF","pontos experimentais sem ajuste de ganho - 504 Ω // 100nF",
"Ideal");
...
%saveas(1,'corrente.jpg')

#coeficientes do polinomio
%p(1)
%p(2)
%print('filename.jpg', '-djpg', '-S872,654');
print(1,'CargaR', '-dpdf', '-S872,554');
print(2,'CargaRC', '-dpdf','-S872,554');

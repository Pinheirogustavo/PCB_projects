...
figure(1); hold on
semilogx(xx,yy,'k', 'linewidth', 1, frequencias, I_ajustada, 'ks', 'linewidth', 1);
semilogx(xx,yy_1,'--k', 'linewidth', 1, frequencias, I_N_ajustada, 'ko', 'linewidth', 1);
...
saveas(1,'correnteXfreq_carga_R_500.jpg')
